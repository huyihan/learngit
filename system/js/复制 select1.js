	...
	select.prototype = {
		init:function(params){
			...
			this.trigger.children('input').css({'width':'90%','height':'.30rem','margin':'0 auto','text-align':'center'})
